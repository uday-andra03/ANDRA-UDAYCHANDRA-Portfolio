...
/**
 * AnimatedCursor.jsx
 * Plain JavaScript version of your splash / fluid cursor.
 * Usage: import './App.css' once, then <AnimatedCursor /> in your root component.
 */
...
export default function AnimatedCursor({
  ...
  useEffect(() => {
    ...
    // --- shader / program helper classes & compile utilities ---
  ...
  return (
    <div className="splash-cursor-root">
      <canvas
        ref={canvasRef}
        id="fluid"
